...
H5_DLL haddr_t H5MF_vfd_alloc(H5F_t *f, hid_t dxpl_id, H5FD_mem_t type, hsize_t size);
H5_DLL haddr_t H5MF_close_alloc(H5F_t *f, H5FD_mem_t alloc_type, hid_t dxpl_id, hsize_t size);
...
H5_DLL herr_t H5MF_xfree_aggrs(H5F_t *f, hid_t dxpl_id);
