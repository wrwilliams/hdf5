...
static herr_t H5S_point_iter_init(const H5S_t *space, H5S_sel_iter_t *iter);
...
static herr_t H5S_point_iter_get_seq_list(H5S_sel_iter_t *iter, size_t maxseq,
 ...
 */
static herr_t
H5S_point_iter_init(const H5S_t *space, H5S_sel_iter_t *iter)
{
...
/*--------------------------------------------------------------------------
 ...
 USAGE
    herr_t H5S_point_iter_get_seq_list(iter,maxseq,maxelem,nseq,nelem,off,len)
...
--------------------------------------------------------------------------*/
static herr_t
H5S_point_iter_get_seq_list(H5S_sel_iter_t *iter, size_t maxseq, size_t maxelem,
    size_t *nseq, size_t *nelem, hsize_t *off, size_t *len)
{
    ...
    *nelem=start_io_left-io_left;
    ...
    FUNC_LEAVE_NOAPI(ret_value)
} /* end H5S_point_iter_get_seq_list() */
