...
H5_DLL herr_t H5Pset_file_space_strategy(hid_t plist_id, H5F_fs_strategy_t, hsize_t threshold);
H5_DLL herr_t H5Pget_file_space_strategy(hid_t plist_id, H5F_fs_strategy_t *strategy, hsize_t *threshold);
