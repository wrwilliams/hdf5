    ...
    void *_thing)
{
    ...
    fprintf(stderr, "%s: \n", FUNC);
    fprintf(stderr, "--------------------------------\n");
    fprintf(stderr, "fspace Client type = %d\n", fspace->client);
    fprintf(stderr, "fspace->addr = %llu, Defined: %d\n", 
            fspace->addr,  H5F_addr_defined(fspace->addr));
    fprintf(stderr, "fspace->sect_addr = %llu, Defined: %d\n", 
            fspace->sect_addr,  H5F_addr_defined(fspace->sect_addr));
    fprintf(stderr, "fspace->serial_sect_count = %d\n", fspace->serial_sect_count);
