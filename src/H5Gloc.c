...
typedef struct {
    /* downward */
    hid_t dxpl_id;              /* DXPL to use for operation */
    unsigned fields;            /* which fields in oinfo to fill in */
    ...
    H5G_loc_t *obj_loc, void *_udata/*in,out*/, H5G_own_loc_t *own_loc/*out*/)
{
    ...
    if(H5O_get_info(obj_loc->oloc, udata->dxpl_id, udata->oinfo, udata->fields) < 0)
...
H5G_loc_info(H5G_loc_t *loc, const char *name, H5O_info_t *oinfo/*out*/,
    unsigned fields, hid_t lapl_id, hid_t dxpl_id)
{
