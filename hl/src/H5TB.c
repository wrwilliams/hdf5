                              ...
                              const void *buf)
{
    ...
    for(i = 0; i < nfields; i++) {
        ...
        /* get the member name */
        if((member_name = H5Tget_member_name(tid, (unsigned)j)) == NULL)
            goto out;
                            ...
                            void *buf)
{
    ...
    for(i = 0, j = 0; i < nfields; i++) {
        /* get the member name */
        if((member_name = H5Tget_member_name(ftype_id, (unsigned)i)) == NULL)
            goto out;
                         ...
                         hsize_t nrecords)
{
    ...
    */
    ...
    if((src_offset = (size_t *)malloc((size_t)nfields * sizeof(size_t))) == NULL)
        goto out;
    if((src_sizes = (size_t *)malloc((size_t)nfields * sizeof(size_t))) == NULL)
        goto out;
    ...
    */
    ...
    if(read_nrecords) {
        if((tmp_buf = (unsigned char *)calloc((size_t)read_nrecords, src_size)) == NULL)
            goto out;
                         ...
                         void *buf)
{
    ...
    */
    ...
    if((tmp_buf = (unsigned char *)calloc((size_t)read_nrecords, type_size)) == NULL)
        goto out;
                            ...
                            hsize_t start2)
{
    ...
    */
    ...
    if((tmp_buf = (unsigned char *)calloc((size_t)nrecords, type_size1)) == NULL)
        goto out;
                          ...
                          const char *dset_name3)
{
    ...
    */
    ...
    if((tmp_fill_buf = (unsigned char *)malloc(type_size)) == NULL)
        goto out;
    ...
    *-------------------------------------------------------------------------
    */
    if((tmp_buf = (unsigned char *)calloc((size_t)nrecords, type_size)) == NULL)
        goto out;
                        ...
                        const void *buf)
{
    ...
    */
    ...
    /* alloc fill value attribute buffer */
    if((tmp_fill_buf = (unsigned char *)malloc(total_size)) == NULL)
        goto out;
    ...
    */
    ...
    for(i = 0; i < nfields + 1; i++) {
        ...
        /* get the member name */
        if((member_name = H5Tget_member_name(tid_1, (unsigned)idx)) == NULL)
            goto out;
    ...
    */
    ...
    if((tmp_buf = (unsigned char *)calloc((size_t)nrecords, (size_t)total_size)) == NULL)
        goto out;
                        ...
                        const char *field_name)
{
    ...
    */
    ...
    for(i = 0; i < nfields; i++) {
        /* get the member name */
        if((member_name = H5Tget_member_name(tid_1, (unsigned)i)) == NULL)
            goto out;
    ...
    */
    ...
    /* alloc fill value attribute buffer */
    if((tmp_fill_buf = (unsigned char *)malloc((size_t) type_size2)) == NULL)
        goto out;
    ...
    */
    for(i = 0; i < nfields; i++) {
        ...
        if((tmp_buf = (unsigned char *)calloc((size_t) nrecords, member_size)) == NULL)
            goto out;
                       ...
                       hid_t ftype_id)
{
    ...
    if((fnames = (char**)calloc(sizeof(char*) * (size_t)nfields, (size_t)nfields)) == NULL)
        goto out;
