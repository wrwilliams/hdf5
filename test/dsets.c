...
////------------passed-------------
            ...
            nerrors += (test_compact_io(my_fapl) < 0          ? 1 : 0);//problem
            nerrors += (test_max_compact(my_fapl) < 0        ? 1 : 0); //problem
...
/*seg fault gone?*/    nerrors += (h5_verify_cached_stabs(FILENAME, fapl) < 0 ? 1 : 0);
