...
test_obj_ref(hid_t fapl)
{
    ...
    if(H5Rcreate_object(fid1, "/Dataset3", &wbuf[0]) < 0)
        FAIL_STACK_ERROR

    /* Create reference to dataset */
    if(H5Rcreate_object(fid1, "/Group1/Dataset2", &wbuf[1]) < 0)
        FAIL_STACK_ERROR

    /* Create reference to group */
    if(H5Rcreate_object(fid1, "/Group1", &wbuf[2]) < 0)
        FAIL_STACK_ERROR

    /* Create reference to named datatype */
    if(H5Rcreate_object(fid1, "/Group1/Datatype1", &wbuf[3]) < 0)
        FAIL_STACK_ERROR

    if(H5Rcreate_object(fid1, "/Group1/Group2/Dataset4", &wbuf[4]) < 0)
        FAIL_STACK_ERROR
    if(H5Rcreate_object(fid1, "/Group1/Group2", &wbuf[5]) < 0)
        FAIL_STACK_ERROR
    if(H5Rcreate_object(fid1, "/Group1/Group2/Link/Dataset5", &wbuf[6]) < 0)
        FAIL_STACK_ERROR

    /* Create reference to root group */
    if(H5Rcreate_object(fid1, "/", &wbuf[7]) < 0)
        FAIL_STACK_ERROR
    ...
    if((dataset2 = H5Ropen_object(wbuf[0], H5P_DEFAULT)) < 0) FAIL_STACK_ERROR
    *buf = '\0';
    ...
    *buf = '\0';
    ...
    namelen = H5Rget_obj_name(wbuf[0], NULL, 0);
    if(namelen != 9) TEST_ERROR
    /* Make sure size parameter is ignored */
    namelen = H5Rget_obj_name(wbuf[0], NULL, 200);
    if(namelen != 9) TEST_ERROR
    
    namelen = H5Rget_obj_name(wbuf[0], (char*)buf, sizeof(buf));
    if(!((HDstrcmp(buf, "/Dataset3") == 0) &&(namelen == 9))) TEST_ERROR
    PASSED()

    HDmemset(buf, 0, sizeof(buf));
    TESTING("getting path to dataset in /Group1");
    if((dataset2 = H5Ropen_object(wbuf[1], H5P_DEFAULT)) < 0) FAIL_STACK_ERROR
    *buf = '\0';
    namelen = H5Iget_name(dataset2, (char*)buf, sizeof(buf));
    if(H5Dclose(dataset2) < 0) FAIL_STACK_ERROR
    if(!((HDstrcmp(buf, "/Group1/Dataset2") == 0) &&(namelen == 16))) TEST_ERROR
    *buf = '\0';
    namelen = H5Rget_obj_name(wbuf[1], (char*)buf, sizeof(buf));
    if(!((HDstrcmp(buf, "/Group1/Dataset2") == 0) &&(namelen == 16))) TEST_ERROR
    PASSED()

    HDmemset(buf, 0, sizeof(buf));
    TESTING("getting path to /Group1");
    if((group = H5Ropen_object(wbuf[2], H5P_DEFAULT)) < 0) FAIL_STACK_ERROR
    *buf = '\0';
    ...
    *buf = '\0';
    namelen = H5Rget_obj_name(wbuf[2], (char*)buf, sizeof(buf));
    if(!((HDstrcmp(buf, "/Group1") == 0) &&(namelen == 7))) TEST_ERROR
    PASSED()

    HDmemset(buf, 0, sizeof(buf));
    TESTING("getting path to datatype in /Group1");
    if((tid1 = H5Ropen_object(wbuf[3], H5P_DEFAULT)) < 0) FAIL_STACK_ERROR
    *buf = '\0';
    ...
    *buf = '\0';
    namelen = H5Rget_obj_name(wbuf[3], (char*)buf, sizeof(buf));
    if(!((HDstrcmp(buf, "/Group1/Datatype1") == 0) &&(namelen == 17))) TEST_ERROR
    PASSED()

    HDmemset(buf, 0, sizeof(buf));
    TESTING("getting path to dataset in nested group");
    if((dataset2 = H5Ropen_object(wbuf[4], H5P_DEFAULT)) < 0) FAIL_STACK_ERROR
    *buf = '\0';
    namelen = H5Iget_name(dataset2, (char*)buf, sizeof(buf));
    if(H5Dclose(dataset2) < 0) FAIL_STACK_ERROR
    if(!((HDstrcmp(buf, "/Group1/Group2/Dataset4") == 0) &&(namelen == 23))) TEST_ERROR
    *buf = '\0';
    namelen = H5Rget_obj_name(wbuf[4], (char*)buf, sizeof(buf));
    if(!((HDstrcmp(buf, "/Group1/Group2/Dataset4") == 0) &&(namelen == 23))) TEST_ERROR
    PASSED()

    HDmemset(buf, 0, sizeof(buf));
    TESTING("getting path to nested group");
    if((group = H5Ropen_object(wbuf[5], H5P_DEFAULT)) < 0) FAIL_STACK_ERROR
    *buf = '\0';
    namelen = H5Iget_name(group, (char*)buf, sizeof(buf));
    if(H5Gclose(group) < 0) FAIL_STACK_ERROR
    if(!((HDstrcmp(buf, "/Group1/Group2") == 0) &&(namelen == 14))) TEST_ERROR
    *buf = '\0';
    namelen = H5Rget_obj_name(wbuf[5], (char*)buf, sizeof(buf));
    if(!((HDstrcmp(buf, "/Group1/Group2") == 0) &&(namelen == 14))) TEST_ERROR
    PASSED()

    HDmemset(buf, 0, sizeof(buf));
    TESTING("getting path to dataset created via hard link");
    if((dataset2 = H5Ropen_object(wbuf[6], H5P_DEFAULT)) < 0) FAIL_STACK_ERROR
    *buf = '\0';
    namelen = H5Iget_name(dataset2, (char*)buf, sizeof(buf));
    if(H5Dclose(dataset2) < 0) FAIL_STACK_ERROR
    if(!((HDstrcmp(buf, "/Group1/Dataset5") == 0) &&(namelen == 16))) TEST_ERROR
    *buf = '\0';
    namelen = H5Rget_obj_name(wbuf[6], (char*)buf, sizeof(buf));
    if(!((HDstrcmp(buf, "/Group1/Dataset5") == 0) &&(namelen == 16))) TEST_ERROR
    PASSED()

    HDmemset(buf, 0, sizeof(buf));
    TESTING("getting path to root group");
    if((group = H5Ropen_object(wbuf[7], H5P_DEFAULT)) < 0) FAIL_STACK_ERROR
    *buf = '\0';
    namelen = H5Iget_name(group, (char*)buf, sizeof(buf));
    if(H5Gclose(group) < 0) FAIL_STACK_ERROR
    if(!((HDstrcmp(buf, "/") == 0) &&(namelen == 1))) TEST_ERROR
    *buf = '\0';
    namelen = H5Rget_obj_name(wbuf[7], (char*)buf, sizeof(buf));
    if(!((HDstrcmp(buf, "/") == 0) &&(namelen == 1))) TEST_ERROR
    PASSED()
    ...
    *buf = '\0';
    ...
    if((dataset2 = H5Ropen_object(wbuf[1], H5P_DEFAULT)) < 0)
        FAIL_STACK_ERROR
...
test_reg_ref(hid_t fapl)
{
	...
	TEST_ERROR
    if(H5Rcreate_region(file_id, REFREG_DSETNAMEV, space_id, &ref[0]) < 0)
	TEST_ERROR
	...
	TEST_ERROR
    if(H5Rcreate_region(file_id, REFREG_DSETNAMEV, space_id, &ref[1]) < 0)
	TEST_ERROR
    ...
    *buf1 = '\0';
    ...
    /* Check H5Rget_obj_name returns the correct length of the name when name is NULL */
    name_size1 = H5Rget_obj_name(ref_out[0], NULL, 0);
    if(name_size1 != 7) TEST_ERROR

    name_size1 = H5Rget_obj_name(ref_out[0], (char*)buf1, NAME_BUF_SIZE);
    ...
    dsetv_id = H5Ropen_object(ref_out[0], H5P_DEFAULT);
    ...
    *buf1 = '\0';
    name_size1 = H5Rget_obj_name(ref_out[1], (char*)buf1, NAME_BUF_SIZE);
    if(!((HDstrcmp(buf1, "/MATRIX") == 0) &&(name_size1 == 7))) TEST_ERROR
    PASSED()
    ...
    if((dsetv_id = H5Ropen_object(ref_out[1], H5P_DEFAULT)) < 0) TEST_ERROR
