...
test_reference_params(void)
{
    ...
    ret = H5Rcreate_object((hid_t)-1, "/Group1/Dataset1", &wbuf[0]);
    ...
    ret = H5Rcreate_region(fid1, "/Group1/Dataset1", (hid_t)-1, &wbuf[0]);
    VERIFY(ret, FAIL, "H5Rcreate_region space");

    /* Test parameters to H5Rcreate_attr (TODO) */

    /* Test parameters to H5Ropen_object */
    dset2 = H5Ropen_object(rbuf[0], (hid_t)-1);
    VERIFY(dset2, FAIL, "H5Ropen_object oapl_id");
    dset2 = H5Ropen_object(HREF_NULL, dapl_id);
    VERIFY(dset2, FAIL, "H5Ropen_object ref");

    /* Test parameters to H5Ropen_region */
    ret_id = H5Ropen_region(HREF_NULL);
    VERIFY(ret_id, FAIL, "H5Ropen_region ref");

    /* Test parameters to H5Rget_obj_type3 */
    ret = H5Rget_obj_type3(HREF_NULL, NULL);
    VERIFY(ret, FAIL, "H5Rget_obj_type3 ref");

    /* Test parameters to H5Rget_obj_name */
    name_size = H5Rget_obj_name(HREF_NULL, NULL, 0);
    VERIFY(name_size, FAIL, "H5Rget_obj_name ref");

    /* Test parameters to H5Rdestroy */
    ret = H5Rdestroy(HREF_NULL);
...
test_reference_obj(void)
{
    ...
    ret = H5Rget_obj_type3(wbuf[0], &obj_type);
    ...
    CHECK(ret, FAIL, "H5Rcreate_object");
    ret = H5Rget_obj_type3(wbuf[1], &obj_type);
    CHECK(ret, FAIL, "H5Rget_obj_type3");
    VERIFY(obj_type, H5O_TYPE_DATASET, "H5Rget_obj_type3");
    ...
    CHECK(ret, FAIL, "H5Rcreate_object");
    ret = H5Rget_obj_type3(wbuf[2], &obj_type);
    CHECK(ret, FAIL, "H5Rget_obj_type3");
    ...
    CHECK(ret, FAIL, "H5Rcreate_object");
    ret = H5Rget_obj_type3(wbuf[3], &obj_type);
    CHECK(ret, FAIL, "H5Rget_obj_type3");
    ...
    /* Open dataset object */
    dset2 = H5Ropen_object(rbuf[0], dapl_id);
    CHECK(dset2, FAIL, "H5Ropen_object");
    ...
    group = H5Ropen_object(rbuf[2], H5P_DEFAULT);
    CHECK(group, FAIL, "H5Ropen_object");
    ...
    tid1 = H5Ropen_object(rbuf[3], H5P_DEFAULT);
    CHECK(tid1, FAIL, "H5Ropen_object");
...
test_reference_region(void)
{
    ...
    VERIFY(dset2, FAIL, "H5Ropen_object");
    ...
    ret = H5Rget_obj_type3(rbuf[0], &obj_type);
    CHECK(ret, FAIL, "H5Rget_obj_type3");
    VERIFY(obj_type, H5O_TYPE_DATASET, "H5Rget_obj_type3");
    ...
    sid2 = H5Ropen_region(rbuf[0]);
    CHECK(sid2, FAIL, "H5Ropen_region");
...
test_reference_region_1D(void)
{
    ...
    /* Try to open objects */
    dset3 = H5Ropen_object(rbuf[0], dapl_id);
    CHECK(dset3, FAIL, "H5Ropen_object");
    ...
    /* Get the hyperslab selection */
    sid3 = H5Ropen_region(rbuf[0]);
    CHECK(sid3, FAIL, "H5Ropen_region");
...
test_reference_obj_deleted(void)
{
    ...
    CHECK(ret, FAIL, "H5Rcreate_object");
    ret = H5Rget_obj_type3(oref, &obj_type);
    CHECK(ret, FAIL, "H5Rget_obj_type3");
    VERIFY(obj_type, H5O_TYPE_DATASET, "H5Rget_obj_type3");
    ...
    dset2 = H5Ropen_object(oref, H5P_DEFAULT);
    VERIFY(dset2, FAIL, "H5Ropen_object");
...
test_reference_group(void)
{
    ...
    gid = H5Ropen_object(rref, H5P_DEFAULT);
    CHECK(gid, FAIL, "H5Ropen_object");
...
test_reference_attr(void)
{
    ...
    ret = H5Rget_obj_type3(ref_wbuf[0], &obj_type);
    CHECK(ret, FAIL, "H5Rget_obj_type3");
    VERIFY(obj_type, H5O_TYPE_DATASET, "H5Rget_obj_type3");
    ...
    CHECK(ret, FAIL, "H5Rcreate_attr");
    ret = H5Rget_obj_type3(ref_wbuf[1], &obj_type);
    CHECK(ret, FAIL, "H5Rget_obj_type3");
    VERIFY(obj_type, H5O_TYPE_DATASET, "H5Rget_obj_type3");
    ...
    CHECK(ret, FAIL, "H5Rcreate_attr");
    ret = H5Rget_obj_type3(ref_wbuf[2], &obj_type);
    CHECK(ret, FAIL, "H5Rget_obj_type3");
    VERIFY(obj_type, H5O_TYPE_GROUP, "H5Rget_obj_type3");
    ...
    CHECK(ret, FAIL, "H5Rcreate_attr");
    ret = H5Rget_obj_type3(ref_wbuf[3], &obj_type);
    CHECK(ret, FAIL, "H5Rget_obj_type3");
    VERIFY(obj_type, H5O_TYPE_NAMED_DATATYPE, "H5Rget_obj_type3");
    ...
    attr = H5Ropen_attr(ref_rbuf[0], H5P_DEFAULT);
    ...
    attr = H5Ropen_attr(ref_rbuf[2], H5P_DEFAULT);
    CHECK(attr, FAIL, "H5Ropen_attr");
    ...
    /* Open attribute on group object */
    attr = H5Ropen_attr(ref_rbuf[3], H5P_DEFAULT);
    CHECK(attr, FAIL, "H5Ropen_attr");
