...
static void test_sohm_size2(int close_reopen)
{
    ...
    if((list_index_big.interleaved - list_index_big.dsets2) >
        ...
        VERIFY(0, 1, "h5_get_file_size");
    if(!close_reopen && (list_index_small.interleaved - list_index_small.dsets2) >
            (btree_index.interleaved - btree_index.dsets2))
        VERIFY(0, 1, "h5_get_file_size");
    ...
    if(!close_reopen && (list_index_small.attrs2 - list_index_small.attrs1) >
     ...
     */
    /* change from != to < */
    if(!close_reopen && (mult_index_med.attrs2 - mult_index_med.attrs1) <
	    (list_index_med.attrs2 - list_index_med.attrs1))
	VERIFY(0, 1, "h5_get_file_size");
    /* change from != to < */
    if(!close_reopen && (mult_index_btree.attrs2 - mult_index_btree.attrs1) <
