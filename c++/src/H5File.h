...
class H5_DLLCPP H5File : public Group {
   public:
        ...
        static bool isAccessible(const char* name, const FileAccPropList& access_plist);
        static bool isAccessible(const H5std_string& name, const FileAccPropList& access_plist);
