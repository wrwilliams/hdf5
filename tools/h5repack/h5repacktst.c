...
int main (void)
{
    ...
    H5F_file_space_type_t	fs_type = 0;	/* file space handling strategy */
    ...
    */
    ...
    if (h5repack_init (&pack_options, 0) < 0)
        GOERROR;
    /* fs_type = H5F_FILE_SPACE_ALL_PERSIST; fs_size = 0 */
    if (h5repack_addfree(fs_type, fs_size, &pack_options) < 0)
        GOERROR;
    ...
    if (h5repack_cmp_pl(FNAME0,FNAME0OUT)<=0)
        GOERROR;
    if (h5repack_vfy_free(FNAME0, FNAME0OUT, &pack_options)<=0)
        GOERROR;
    ...
    */
    ...
    if (h5repack_cmp_pl(FNAME1,FNAME1OUT)<=0)
        GOERROR;
    if (h5repack_vfy_free(FNAME1, FNAME1OUT, &pack_options)<=0)
        GOERROR;
    if (h5repack_end (&pack_options) < 0)
        GOERROR;
    PASSED();
    ...
    */
    ...
    if (h5repack_cmp_pl(FNAME2,FNAME2OUT)<=0)
        GOERROR;
    if (h5repack_vfy_free(FNAME2, FNAME2OUT, &pack_options)<=0)
        GOERROR;
    if (h5repack_end (&pack_options) < 0)
        GOERROR;
    PASSED();
    ...
    */
    ...
    if (h5repack_cmp_pl(FNAME3,FNAME3OUT)<=0)
        GOERROR;
    if (h5repack_vfy_free(FNAME3, FNAME3OUT, &pack_options)<=0)
        GOERROR;
    if (h5repack_end (&pack_options) < 0)
        GOERROR;
    ...
    */
    ...
    if (h5repack_verify(FNAME5OUT,&pack_options)<=0)
        GOERROR;
    if (h5repack_vfy_free(FNAME5, FNAME5OUT, &pack_options)<=0)
        GOERROR;
    if (h5repack_end (&pack_options) < 0)
        GOERROR;
    PASSED();
    ...
    */
    ...
    if (h5repack_verify(FNAME4OUT,&pack_options)<=0)
        GOERROR;
    if (h5repack_vfy_free(FNAME4, FNAME4OUT, &pack_options)<=0)
        GOERROR;
    if (h5repack_end (&pack_options) < 0)
        GOERROR;
    PASSED();
    ...
    */
    ...
    if (h5repack_addlayout("dset1:CHUNK=20x10",&pack_options) < 0)
        GOERROR;
    /* fs_type = H5F_FILE_SPACE_ALL; fs_size = 1 */
    if (h5repack_addfree(H5_INC_ENUM(H5F_file_space_type_t, fs_type), ++fs_size, &pack_options) < 0)
        GOERROR;
    if (h5repack(FNAME4,FNAME4OUT,&pack_options) < 0)
        GOERROR;
    if (h5diff(FNAME4,FNAME4OUT,NULL,NULL,&diff_options) >0)
    ...
    */
    ...
    if (h5repack_addlayout("dset1:COMPA",&pack_options) < 0)
        GOERROR;
    /* fs_type = H5F_FILE_SPACE_AGGR_VFD; fs_size = 2 */
    if (h5repack_addfree(H5_INC_ENUM(H5F_file_space_type_t, fs_type), ++fs_size, &pack_options) < 0)
        GOERROR;
    if (h5repack(FNAME4,FNAME4OUT,&pack_options) < 0)
        GOERROR;
    ...
    */
	...
	if (h5repack_addfree(fs_type, fs_size, &pack_options) < 0)
        ...
        if (h5repack_cmp_pl(FNAME7,FNAME7OUT)<=0)
            GOERROR;
	if (h5repack_vfy_free(FNAME7, FNAME7OUT, &pack_options)<=0)
	    GOERROR;
        if (h5repack_end (&pack_options) < 0)
            GOERROR;
    ...
    if (h5repack_verify(FNAME8OUT,&pack_options)<=0)
        GOERROR;
    if (h5repack_vfy_free(FNAME8, FNAME8OUT, &pack_options)<=0)
	GOERROR;
    if (h5repack_end (&pack_options) < 0)
        GOERROR;
    ...
    if (h5repack_verify(FNAME9OUT,&pack_options)<=0)
        GOERROR;
    if (h5repack_vfy_free(FNAME9, FNAME9OUT, &pack_options)<=0)
	GOERROR;
    if (h5repack_end (&pack_options) < 0)
        GOERROR;
    ...
    if (h5repack_verify(FNAME10OUT,&pack_options)<=0)
        GOERROR;
    if (h5repack_vfy_free(FNAME10, FNAME10OUT, &pack_options)<=0)
	GOERROR;
    if (h5repack_end (&pack_options) < 0)
        GOERROR;
    ...
    if (h5repack_verify(FNAME12OUT,&pack_options)<=0)
        GOERROR;
    if (h5repack_vfy_free(FNAME12, FNAME12OUT, &pack_options)<=0)
	GOERROR;
    if (h5repack_end (&pack_options) < 0)
        GOERROR;
    ...
    if (h5repack_verify(FNAME13OUT,&pack_options)<=0)
        GOERROR;
    if (h5repack_vfy_free(FNAME13, FNAME13OUT, &pack_options)<=0)
	GOERROR;
    if (h5repack_end (&pack_options) < 0)
        GOERROR;
    ...
    */
	...
	if (h5repack_addfree(fs_type, fs_size, &pack_options) < 0)
        ...
        if (h5repack_verify(FNAME11OUT,&pack_options)<=0)
            GOERROR;
	if (h5repack_vfy_free(FNAME11, FNAME11OUT, &pack_options)<=0)
	    GOERROR;
        if (h5repack_end (&pack_options) < 0)
            GOERROR;
    ...
    */
    ...
    if (h5repack_init (&pack_options, 0) < 0)
        GOERROR;
    /* fs_type = H5F_FILE_SPACE_VFD; fs_size = 3 */
    if (h5repack_addfree(H5_INC_ENUM(H5F_file_space_type_t, fs_type), fs_size, &pack_options) < 0)
        GOERROR;
    ...
    if (h5repack_verify(FNAME14OUT,&pack_options)<=0)
        GOERROR;
    if (h5repack_vfy_free(FNAME14, FNAME14OUT, &pack_options)<=0)
	GOERROR;
    if (h5repack_end (&pack_options) < 0)
        GOERROR;
    PASSED();
    ...
    */
    ...
    if (h5repack_verify(FNAME15OUT,&pack_options)<=0)
        GOERROR;
    if (h5repack_vfy_free(FNAME15, FNAME15OUT, &pack_options)<=0)
	GOERROR;
    if (h5repack_end (&pack_options) < 0)
        GOERROR;
    PASSED();
    ...
    */
    ...
    if(verify_userblock(FNAME16OUT) < 0)
        GOERROR;
    if (h5repack_vfy_free(FNAME16, FNAME16OUT, &pack_options)<=0)
	GOERROR;
    if(h5repack_end(&pack_options) < 0)
        GOERROR;
    PASSED();
